...
export default function BookPage() {
    ...
    let comments = [
        ...
        {id:3,name:"stan",review:"It's a well known fact that I will read pretty much any book with a magical school but so is the fact that I don't like waiting for the next book in a series.",rating:"2",date:"2012/05/20",points:["waste-of-money","sucks","fantasy"],likes:1000,comments:500,spoiler:true},
        ...
        {id:5,name:"Son",review:"In a small town is an innkeeper named Kote, living a quiet life, when one day a man enters his establishment looking for Kvothe, the man of myths and legends.",rating:"3",date:"2022/07/9",points:["waste-of-money","fantasy"],likes:1000,comments:500,spoiler:true},
    ...
    const dataForReviewPage = {bookId}
        ...
        <div className="bookpage--container">
            ...
            <div className="bookpage--content">
                ...
                {comments && comments.length!==0 ?
                    <>
                    {reviewSection}
                    <Paginate scrollRef={reviewRef} totalItems={100} itemsPerPage={10} />
                    </>
                    :
